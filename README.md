...
## libft
- c의 <string.h>에서 사용하는 문자열 처리 함수들을 직접 구현해보는 과제입니다.
...
- 실행될 때마다 다음 줄을 반환해야 하므로 static 변수로 반환되지 않았지만 read를 통해 읽은 내용을 저장해둡니다.
...
## cub3D
- 최초의 3D 게임 울펜슈타인과 같은 형식의 맵을 구현해보는 과제입니다.
